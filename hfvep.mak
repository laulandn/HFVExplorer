...
!IF "$(CFG)" == ""
CFG=HFVExplorer - Power Macintosh Release
!MESSAGE No configuration specified. Defaulting to HFVExplorer - Power Macintosh Release.
!ENDIF 

!IF "$(CFG)" != "HFVExplorer - Power Macintosh Release" && "$(CFG)" !=\
 "HFVExplorer - Power Macintosh Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "HFVExplorer.mak" CFG="HFVExplorer - Power Macintosh Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "HFVExplorer - Power Macintosh Release" (based on "Power Macintosh Application")
!MESSAGE "HFVExplorer - Power Macintosh Debug" (based on "Power Macintosh Application")
!MESSAGE 
...
!IF  "$(CFG)" == "HFVExplorer - Power Macintosh Release"
...
CPP_PROJ=/nologo /AL /Q68s /Q68m /W3 /GX /Zi /Od /D "_WINDOWS" /D "_MAC" /D\
 "_68K_" /D "WIN32" /D "_DEBUG" /Fp"$(INTDIR)/HFVExplorer.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\Release/
...
!ELSEIF  "$(CFG)" == "HFVExplorer - Power Macintosh Debug"
...
ALL : "$(OUTDIR)\HFVExplorer.exe" "$(OUTDIR)\HFVExplorer.trg"
...
CPP_PROJ=/nologo /AL /Q68s /W3 /GX /O2 /D "_WINDOWS" /D "_MAC" /D "_68K_" /D\
 "WIN32" /D "NDEBUG" /Fp"$(INTDIR)/HFVExplorer.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\MacRel/
CPP_SBRS=
...
LINK32_FLAGS=/nologo /MAC:bundle /MAC:type="APPL" /MAC:creator="????"\
 /pdb:"$(OUTDIR)/HFVExplorer.pdb" /machine:M68K /out:"$(OUTDIR)/HFVExplorer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\AskDir.obj" \
	"$(INTDIR)\AskDump.obj" \
	"$(INTDIR)\AskNewVolume.obj" \
...
MFILE32_FILES= \
	"$(OUTDIR)/HFVExplorer.exe"

"$(OUTDIR)\HFVExplorer.trg" : "$(OUTDIR)" $(MFILE32_FILES)
    $(MFILE32) $(MFILE32_FLAGS) .\MacRel\HFVExplorer.exe\
 "$(MFILE32_DEST):HFVExplorer.exe">"$(OUTDIR)\HFVExplorer.trg"
